        ...
        <div class="col-md-6">
            <div class="card stat-card shadow-sm">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted mb-3">View all prescriptions issued by your doctors.</p>
                    <a href="prescriptions.php" class="btn btn-info btn-sm text-white">View Prescriptions</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card stat-card shadow-sm">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted mb-3">Update your personal and medical information.</p>
                    <a href="profile.php" class="btn btn-warning btn-sm">Edit Profile</a>
                </div>
            </div>
        </div>
    </div>
